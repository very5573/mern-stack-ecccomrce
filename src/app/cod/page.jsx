...
const CODPage = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-50 px-4 pt-12">

      {/* ✅ TOP STEPPER (AMAZON-STYLE) */}
      <Box className="w-full max-w-3xl mb-8">
      ...
      {/* ✅ MAIN CARD CONTENT */}
      <Card className="max-w-3xl w-full shadow-2xl rounded-2xl">
