    ...
    () =>
      orders.map(order => (
        ...
        >
          ...
          <td className="px-6 py-4 border-r border-default">{order.user?.name}</td>
          <td className="px-6 py-4 border-r border-default">{order.user?.email}</td>
          <td className="px-6 py-4 font-semibold border-r border-default">₹{order.totalPrice}</td>
      ...
      {selectedOrders.length > 0 && (
        <div className="mb-4 flex items-center gap-4">
          <OrderStatusUpdater
            ...
            onStatusChange={() => fetchOrders(page)}
          />
          <AppButton variant="outlined" color="error" onClick={confirmBulkDelete}>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-body border-collapse">
          ...
          <thead className="text-sm text-body bg-neutral-secondary-medium border-b border-t border-default-medium bg-amber-300">
            <tr>
              ...
              <th className="px-6 py-3 font-medium border-r border-default">Order ID</th>
              <th className="px-6 py-3 font-medium border-r border-default">User</th>
              <th className="px-6 py-3 font-medium border-r border-default">Email</th>
              <th className="px-6 py-3 font-medium border-r border-default">Total</th>
              <th className="px-6 py-3 font-medium border-r border-default">Status</th>
              <th className="px-6 py-3 font-medium border-r border-default">View</th>
